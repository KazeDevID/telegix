...
import { createWebhookCallback, createPagesWebhookHandler } from './webhook.js';
...
export class Telegix extends Composer {
  ...
  /**
   * Returns a Cloudflare Pages Functions / Cloudflare Workers / Fetch API webhook handler
   * @param {object} [options]
   * @returns {Function}
   */
  pagesWebhookHandler(options = {}) {
    return createPagesWebhookHandler(this, options);
  }
}
